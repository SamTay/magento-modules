 ...
 */
class BlueAcorn_AttributeFlag_Model_Flag_New
    ...
    implements BlueAcorn_AttributeFlag_Model_FlagInterface
{
    ...
    public function __construct()
    {
        ...
        $this->_dateStartAttribute = 'news_from_date';
        $this->_dateEndAttribute = 'news_to_date';
    }
    ...
    {
        return 'Applies to products that have an active "New" date range.';
    }
}